    ...
    <nav className="xl:hidden">
      <div className="flex justify-between  items-center px-3 py-5 border-b border-gray2">
        ...
        <Link href="/" className="block">
          <svg xmlns="http://www.w3.org/2000/svg" width="200.272" height="20.608" viewBox="0 0 229.272 23.608">
        ...
        <Link
          className="block text-sm text-center cursor-pointer bg-blue text-white px-4 py-2 rounded-sm border border-gray2"
          href="/login"
        >
          Log In
        </Link>
      ...
      <ul
        className={`fixed top-16 left-0 text-lg grid gap-y-3 w-full z-50 bg-gray px-6 py-6 transition-all duration-300 ${
      ...
      >
        ...
        <li>
          <Link href="/commercial">Commercial & Speciality</Link>
        </li>
        <li>
